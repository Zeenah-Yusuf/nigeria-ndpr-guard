...
import { ShieldCheck, ArrowDown, ArrowRight, BadgeCheck, Building2, Landmark, Globe } from "lucide-react";
...
const HeroSection = () => {
  ...
  const stats = [
    { value: "4", labelKey: "hero.stats.frameworks", icon: Building2 },
    { value: "₦10M", labelKey: "hero.stats.maxFine", icon: Landmark },
    { value: "72hrs", labelKey: "hero.stats.breachDeadline", icon: Globe },
  ];
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-24 pb-12">
          ...
          {stats.map(stat => {
            ...
            return (
              <div key={stat.labelKey} className="text-center">
                <Icon className="w-5 h-5 mx-auto mb-1" style={{ color: "hsl(152, 60%, 55%)" }} />
        ...
        <div className="animate-fade-in mt-12" style={{ animationDelay: "0.7s" }}>
          <button onClick={scrollToTrust} className="group" aria-label="Scroll to learn more">
